...
_G.worldCollisionFilter 	= {categoryBits = 1, maskBits = 14}
_G.playerCollisionFilter 	= { categoryBits = 2, maskBits = 9 }
_G.powerCollisionFilter 	= { categoryBits = 4, maskBits = 13 }
